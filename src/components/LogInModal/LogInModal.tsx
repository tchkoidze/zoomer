  ...
  return (
    <ConfigProvider theme={customTheme}>
      <Modal
        ...
        footer={false}
        onCancel={closeModal}
        className=" !w-[400px] md:!w-[440px] top-[80px]"
        maskClosable={false}
        style={{}}
        closeIcon={
          <img
      ...
      >
        <div className="flex">
          <div
            ...
            onClick={() => setOnAuthorization(true)}
          >
            <p
              className={`${
                onAuthorization
                  ? "firago-bold text-orange-main dark:text-text-dark-orange-main"
                  : "firago-medium"
              } text-center text-black-main dark:text-dark-black-main text-base leading-[19px] mt-2 mb-[14px]`}
            >
            ...
            <hr
              className={`border border-solid ${
                onAuthorization
                  ? " border-orange-main dark:border-dark-orange-main"
                  : "border-border-white dark:border-border-dark-white"
              }`}
            />
          </div>
          <div
            className="w-1/2 cursor-pointer"
            onClick={() => setOnAuthorization(false)}
          >
            <p
              className={`${
                !onAuthorization
