...
export default function AuthorizationForm() {
  ...
  return (
    ...
    >
          ...
          },
          {
            validator: (_, value) => {
              ...
              return Promise.reject(
                new Error(formatMessage({ id: "input.password.short" }))
              ); // Add a message for short password
            },
          },
        ]}
        hasFeedback
      ...
      <Form.Item>
        {isError && (
          <div className="firago-bold text-red-08 text-sm leading-[17px] mb-2">
        ...
        >
          <p className="firago-bold text-sm leading-[17px]">
