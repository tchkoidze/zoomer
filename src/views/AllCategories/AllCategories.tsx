  ...
  const categoryElements = categories.map((cat: ProductCategory) => {
    return (
      <Link
        ...
        className="no-underline firago-semibold text-text-blue dark:text-dark-text-blue text-lg hover:text-orange-main transition-all duration-200 ease-in-out delay-0"
      >
  ...
  return (
    <>
      ...
      <div className="custom-container pt-[30px] pb-[60px] min-h-[80vh] w-full">
        <h3 className="firago-medium text-base text-text-blue dark:text-dark-text-blue leading-6">
        ...
        <div className="grid grid-cols-3 gap-y-7 w-full">
          {categoryElements}
        </div>
      </div>
    </>
