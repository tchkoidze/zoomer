      ...
      <div className="hidden lg:block">
        <div className="custom-container py-3 items-center grid grid-flow-col auto-cols-max justify-between relative">
          <img
            src={headerLogo}
            alt="main logo"
            className="h-[28px] lg:h-[40px] cursor-pointer"
            onClick={() => navigate("/")}
          />
          <div>
            <div className=" w-[100%] grid grid-flow-col gap-3 items-center">
              ...
              <>
                <NavButton
                  ...
                  icon={lightMode ? cartIcon : cartIconDark}
                  cartItems={cartItems.length}
                  onClick={handleCartClick}
                  onMouseEnter={showCartModal}
                  onMouseLeave={
                    handleMouseLeave
                  } /*onMouseEnter={showCartModal} onMouseLeave={closeCartModal}*/
                />
                ...
                {authStage !== AuthStageEnum.AUTHORIZED ? (
                  <>
                    <NavButton
                      text={"log.in"}
                      type={ButtonEnum.DEFAULT}
                      icon={lightMode ? userIcon : userIconDark}
      ...
      <div className="block lg:hidden">
        <div className="custom-container py-3 relative">
          <div className="grid grid-flow-col items-center justify-between">
            <div className="flex items-center">
              <div className="w-6 mr-2">
                <img
                  ...
                  alt="categories burger logo"
                  className="w-auto cursor-pointer block ml-auto"
                  onClick={() => {
                    !categoriesTabModal
                      ? showCategoriesTabModal()
                      : closeCategoriesTabModal();
                  }}
                />
              </div>
            ...
            <div className="flex items-center  ">
              <img
                src={lightMode ? searchIcon : searchIconDark}
                alt="search icon"
                className="h-6 w-6 cursor-pointer"
                onClick={() => {
                  !searchInput ? showSearchInput() : closeSearchInput();
                }}
              />
              <img
                src={lightMode ? cartIcon : cartIconDark}
                alt="cart icon"
                className="h-6 w-6 cursor-pointer"
