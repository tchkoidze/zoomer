...
export default function LanguageSelector() {
  ...
  const menuItems: MenuProps["items"] = [
    {
      key: "1",
      label: (
        <p className="firago-medium text-black dark:!text-dark-black-main">
          GEO
        </p>
      ),
      onClick: () => {
  ...
  return (
    <Dropdown
      menu={{ items: menuItems, style: menuStyles }}
      placement="top"
      trigger={["click"]}
    >
      <Button style={customStyles}>
        <div className="flex items-center ">
          ...
          <span
            style={{ color: "initial" }}
            className="firago-medium text-sm leading-[17px] text-black dark:!text-dark-black-main"
          >
            {locale}
          </span>
        </div>
